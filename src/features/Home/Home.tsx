...
const Home: React.FC = () => {
    ...
    return (
        <div className="h-screen w-screen flex flex-wrap flex-row items-center text-center pb-40">
            ...
            <div className="lg:w-1/3 align-left" style={{ maxWidth: "100%", height: "auto" }}>
