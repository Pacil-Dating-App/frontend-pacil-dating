...
export default function Login() {
  ...
  const [authError, setAuthError] = useState(false); // State to show/hide authentication error message
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (formData.user.username === DUMMY_USER.username && formData.user.password === DUMMY_USER.password) {
      ...
      setAuthError(true); // Set error state to true to show error message
    }
  };
